...
const translations = {
  en: {
    ...
    'setup.windows.step2.title': 'Run setup-vms.bat',
    'setup.windows.step2.desc': 'Double-click setup-vms.bat — installs Node.js dependencies, checks FFmpeg, and configures the .env file automatically.',
    'setup.windows.step3.title': 'Launch with start-vms.bat',
    'setup.windows.step3.desc': 'Double-click start-vms.bat — starts both servers and opens the dashboard in your browser automatically at http://localhost:42100.',
    'setup.windows.step4.title': 'Stop with stop-vms.bat',
    'setup.windows.step4.desc': 'Double-click stop-vms.bat to gracefully shut down all servers and free ports 42100, 42200, and 42300.',
  ...
  pt: {
    ...
    'setup.windows.step2.title': 'Execute setup-vms.bat',
    'setup.windows.step2.desc': 'Dê duplo clique no setup-vms.bat — instala dependências, verifica FFmpeg e configura o arquivo .env automaticamente.',
    'setup.windows.step3.title': 'Inicie com start-vms.bat',
    'setup.windows.step3.desc': 'Dê duplo clique no start-vms.bat — inicia ambos os servidores e abre o painel automaticamente em http://localhost:42100.',
    'setup.windows.step4.title': 'Encerre com stop-vms.bat',
    'setup.windows.step4.desc': 'Dê duplo clique no stop-vms.bat para encerrar todos os servidores e liberar as portas 42100, 42200 e 42300.',
  ...
  es: {
    ...
    'setup.windows.step2.title': 'Ejecutar setup-vms.bat',
    'setup.windows.step2.desc': 'Doble clic en setup-vms.bat — instala dependencias, verifica FFmpeg y configura el archivo .env automáticamente.',
    'setup.windows.step3.title': 'Lanzar con start-vms.bat',
    'setup.windows.step3.desc': 'Doble clic en start-vms.bat — inicia ambos servidores y abre el panel automáticamente en http://localhost:42100.',
    'setup.windows.step4.title': 'Detener con stop-vms.bat',
    'setup.windows.step4.desc': 'Doble clic en stop-vms.bat para detener todos los servidores y liberar los puertos 42100, 42200 y 42300.',
